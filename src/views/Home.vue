            ...
            <div class="grid-content bg-purple">
                <el-card class="box-card">
                    ...
                    <div class="login-info">
                        <p>上次登陆时间 <span>2024-06-01</span></p>
...
<script>
import { getData } from '../api'  //引入api接口
...
export default {
    ...
    mounted() {
        getData().then(({ data }) => {
            ...
            var echarts1Option = {}
            //处理数据xAxis
            const { orderData, userData, videoData } = data.data //解构
            const xAxis = Object.keys(orderData.data[0])
            const xAxisData = {
                data: xAxis
            }
            echarts1Option.xAxis = xAxisData//x轴数据赋值给echarts1Option
...
.num {
    ...
    .detail {
        display: flex;
        flex-direction: column; //设置方向为垂直方向
